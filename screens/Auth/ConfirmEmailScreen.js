...
import { confirmEmail } from '../../components/services/AuthService';
//import * as firebase from 'firebase';

export default class ConfirmEmailScreen extends React.Component {
        ...
        return (
            <View style={styles.container}
                ...
                <View style={styles.loginBox}>
                    ...
                    <Text style={styles.defaultText}>Fale o seu email para enviarmos a confirmação da sua conta.</Text>
