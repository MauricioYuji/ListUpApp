...
export default class GameScreen extends React.Component {
    ...
    renderThumb = (item) => {
        ...
        if (item == null) {
            ...
            return (<Image source={{ uri: "https://firebasestorage.googleapis.com/v0/b/teste-925f4.appspot.com/o/images%2F" + item + ".jpg?alt=media" }} style={{ width: '100%', height: columnWidth }} />);
        }
    }
    _renderlist() {
